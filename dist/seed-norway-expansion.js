...
exports.seedNorwayExpansion = seedNorwayExpansion;
...
function seedNorwayExpansion() {
    // Idempotent: check if expansion has already run
    const existing = marketplace_registry_1.marketplaceRegistry.getActiveAgents();
    const hasExpansion = existing.some((a) => a.name === "Bondens Marked Bergen" || a.name === "REKO-ringen Trondheim");
    if (hasExpansion) {
...
//# sourceMappingURL=seed-norway-expansion.js.map