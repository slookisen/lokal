...
exports.seedExpansionV5 = seedExpansionV5;
...
function seedExpansionV5() {
    const existing = marketplace_registry_1.marketplaceRegistry.getActiveAgents();
    const hasV5 = existing.some((a) => a.name === "Ege Frukt & Grønt — Frogner" || a.name === "Mathallen Tromsø");
    if (hasV5) {
    ...
    const cities = new Set(allAgents.map((a) => {
        try {
    ...
    console.log(`      ${allAgents.filter((a) => a.role === "producer").length} producers`);
...
//# sourceMappingURL=seed-expansion-v5.js.map