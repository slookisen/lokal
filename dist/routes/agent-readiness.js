...
function mcpServerCard() {
    ...
    return {
        ...
        authentication: {
            schemes: ["apiKey"],
            header: "X-API-Key",
            description: "Read-only calls (search, discover, get) are open. Write operations require an API key.",
        },
        keywords: [
            "local food",
            "a2a",
    ...
    return {
        ...
        skills: [
            ...
            },
            {
                ...
                description: "Onboard a new farm, shop, or cooperative. Once registered, the producer gets an A2A Agent Card and becomes discoverable.",
            ...
            },
            {
                ...
                description: "Natural-language search across producers. Compare prices, delivery options, organic certifications, availability.",
            ...
            },
            {
                ...
                description: "Initiate a buyer-seller conversation. Offer / accept / reject flow with full transaction tracking.",
...
// Legacy path
router.get("/.well-known/skills/index.json", (_req, res) => {
    res.header("Content-Type", "application/json; charset=utf-8");
    res.header("Cache-Control", "public, max-age=300");
    res.json(agentSkillsIndex());
});
...
router.get("/.well-known/agent-skills/:id", (req, res) => {
    const detail = SKILL_DETAILS[req.params.id];
    if (!detail) {
...
//# sourceMappingURL=agent-readiness.js.map