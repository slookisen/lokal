...
exports.seedExpansionV6 = seedExpansionV6;
...
function seedExpansionV6() {
    const existing = marketplace_registry_1.marketplaceRegistry.getActiveAgents();
    const hasV6 = existing.some((a) => a.name === "Kinsarvik Naturkost — Bergen Sentrum" || a.name === "Bakke Gård — Modum/Sigdal");
    if (hasV6) {
    ...
    marketplace_registry_1.marketplaceRegistry.register({
        ...
        role: "logistics", // delivery service
    ...
    const newCount = marketplace_registry_1.marketplaceRegistry.getActiveAgents().length - existing.length;
    console.log(`\n✅ Expansion v6 complete — ${newCount} new agents added.`);
    console.log(`   Total agents now: ${marketplace_registry_1.marketplaceRegistry.getActiveAgents().length}\n`);
}
//# sourceMappingURL=seed-expansion-v6.js.map