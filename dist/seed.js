...
const producer_agent_1 = require("./services/producer-agent");
...
function seedData() {
    ...
    const aker = producer_agent_1.producerAgent.register({
        name: "Aker Gård",
        type: "farm",
    ...
    const akerTomater = producer_agent_1.producerAgent.addProduct({
        producerId: aker.id,
        name: "Tomater",
        category: "vegetables",
        unit: "kg",
    ...
    const akerGulrot = producer_agent_1.producerAgent.addProduct({
        producerId: aker.id,
        name: "Gulrøtter",
        category: "vegetables",
        unit: "kg",
    ...
    const akerUrter = producer_agent_1.producerAgent.addProduct({
        producerId: aker.id,
    ...
    const akerEgg = producer_agent_1.producerAgent.addProduct({
        producerId: aker.id,
    ...
    const gronland = producer_agent_1.producerAgent.register({
        name: "Grønland Grønt",
        type: "shop",
    ...
    const gronTomater = producer_agent_1.producerAgent.addProduct({
    ...
    const gronAgurk = producer_agent_1.producerAgent.addProduct({
        producerId: gronland.id,
        name: "Agurk",
        category: "vegetables",
        unit: "piece",
    ...
    const gronEpler = producer_agent_1.producerAgent.addProduct({
        producerId: gronland.id,
        name: "Norske epler",
        category: "fruits",
        unit: "kg",
    ...
    const lokka = producer_agent_1.producerAgent.register({
    ...
    const lokkaHonning = producer_agent_1.producerAgent.addProduct({
        producerId: lokka.id,
        name: "Lokal honning",
        category: "honey",
        unit: "piece", // jar
    ...
    const lokkaBasilikum = producer_agent_1.producerAgent.addProduct({
        producerId: lokka.id,
        name: "Basilikum",
        category: "herbs",
        unit: "bunch",
    ...
    const andel = producer_agent_1.producerAgent.register({
    ...
    const andelPoteter = producer_agent_1.producerAgent.addProduct({
        producerId: andel.id,
        name: "Nypoteter",
        category: "vegetables",
        unit: "kg",
    ...
    const andelGronkaal = producer_agent_1.producerAgent.addProduct({
        producerId: andel.id,
        name: "Grønnkål",
        category: "vegetables",
        unit: "bunch",
    ...
    const andelJordbaer = producer_agent_1.producerAgent.addProduct({
        producerId: andel.id,
        name: "Jordbær",
        category: "berries",
        unit: "box",
    ...
    const bygdoy = producer_agent_1.producerAgent.register({
    ...
    const bygdoyEpler = producer_agent_1.producerAgent.addProduct({
    ...
    const bygdoyPlommer = producer_agent_1.producerAgent.addProduct({
        producerId: bygdoy.id,
        name: "Plommer",
        category: "fruits",
        unit: "kg",
    ...
    const nordlys = producer_agent_1.producerAgent.register({
    ...
    const nordlysCherryTomat = producer_agent_1.producerAgent.addProduct({
    ...
    const nordlysBifftomat = producer_agent_1.producerAgent.addProduct({
        producerId: nordlys.id,
    ...
    const nordlysMandelpoteter = producer_agent_1.producerAgent.addProduct({
        producerId: nordlys.id,
        name: "Poteter (Mandel)",
        category: "vegetables",
        unit: "kg",
    ...
    const nordlysGulloye = producer_agent_1.producerAgent.addProduct({
        producerId: nordlys.id,
    ...
    const nordlysEpler = producer_agent_1.producerAgent.addProduct({
        producerId: nordlys.id,
    ...
    const nordlysAgurk = producer_agent_1.producerAgent.addProduct({
        producerId: nordlys.id,
        name: "Agurk",
        category: "vegetables",
        unit: "piece",
    ...
    const nordlysSalat = producer_agent_1.producerAgent.addProduct({
        producerId: nordlys.id,
        name: "Salat (Romaine)",
        category: "vegetables",
        unit: "piece",
    ...
    const nordlysLok = producer_agent_1.producerAgent.addProduct({
        producerId: nordlys.id,
        name: "Løk (Rødløk)",
        category: "vegetables",
        unit: "kg",
    ...
    for (const cp of chainPrices) {
        store_1.store.setChainPrice(cp.productName, cp);
    }
    console.log("\n🌱 Lokal — Seed data loaded:");
    console.log(JSON.stringify(store_1.store.getStats(), null, 2));
}
