...
exports.seedExpansionV7 = seedExpansionV7;
...
function seedExpansionV7() {
    const existing = marketplace_registry_1.marketplaceRegistry.getActiveAgents();
    const hasV7 = existing.some((a) => a.name === "Bondens Butikk Vulkan — Mathallen Oslo" || a.name === "Slettå Gårdsutsalg — Randaberg");
    if (hasV7) {
...
//# sourceMappingURL=seed-expansion-v7.js.map