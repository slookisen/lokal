...
exports.linkHeaders = linkHeaders;
exports.markdownNegotiation = markdownNegotiation;
...
function linkHeaders(_req, res, next) {
...
function markdownNegotiation(req, res, next) {
    ...
    if (req.method !== "GET")
        return next();
    const wantsMarkdown = queryFormat === "md" ||
