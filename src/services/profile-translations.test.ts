...
export async function runProfileTranslationsTests(opts: { log?: boolean } = {}): Promise<TestSummary> {
  ...
  try {
    ...
    const np1 = svc.verifyTranslationDeterministic("Bondens marked i sentrum av Sogndal, Sogn og Fjordane. Del av Smak av Nordhordland.", "Farmers' market in the centre of Sogndal, Sogn og Fjordane. Part of Smak av Nordhordland.", "en");
