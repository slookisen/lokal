      ...
      skills: [
        {
          ...
          description: `Search a registry of ${stats.totalAgents || 1195}+ verified local food producers in Norway. ` +
            ...
            `Søk blant ${stats.totalAgents || 1195}+ verifiserte lokale matprodusenter i Norge.`,
          tags: [
